...
local function MakePreparedFood(data)
    ...
    if data.overridebuild then
        ...
        table.insert(foodassets, Asset("ATLAS", "images/cookbook_images/" .. data.basename .. ".xml")) --食谱书贴图
        table.insert(foodassets, Asset("IMAGE", "images/cookbook_images/" .. data.basename .. ".tex")) --食谱书贴图
    end
...
for k, v in pairs(require("zskb_preparedfoods")) do
