...
local function addcanopyrow(widget, row)
    ...
    for i = 1, #POS_INDEX do
        ...
        new_widget_AnimState:SetBank("zskb_leaves_canopy")
        new_widget_AnimState:SetBuild("zskb_leaves_canopy")
...
local Z_leafcanopy = Class(Widget, function(self, owner)
    self.owner = owner
    Widget._ctor(self, "Z_leafcanopy")
...
function Z_leafcanopy:OnUpdate(dt)
    ...
    self.under_leaves = self.owner._underzskbleafcanopy and self.owner._underzskbleafcanopy:value()
